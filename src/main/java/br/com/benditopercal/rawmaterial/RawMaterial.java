...
public class RawMaterial {
    ...
    public RawMaterial(String name, Category category, Unit unit, BigDecimal minimumStock) {
        this.name = name;
    ...
    public void decreaseStock(BigDecimal quantity) {
        if (this.quantityInStock.compareTo(quantity) < 0) {
            throw new IllegalStateException("Estoque insuficiente de matéria-prima: " + this.name);
        }
